...
//    }
    ...
    // относится к ДЗ
    public void toGo() {
        System.out.printf("может быть животное %s умеет ходить, а может быть и нет...%n", getType());
    }

    public void fly() {
        System.out.printf("может быть животное %s умеет летать, а может быть и нет...%n", getType());
    }

    public void swim() {
        System.out.printf("может быть животное %s умеет плавать, а может быть и нет...%n", getType());
    }
